...
- 목표: **정책·승인·감사 하에 다양한 도구를 계획적으로 사용하는 조직용 orchestration runtime/control plane**을 **보안/조직 운영 가능 형태**로 설계한다.
...
## 5) 지금 단계의 선언
- 아이디에이션/경계 정렬을 마쳤고, 제품 정의는 **다양한 도구를 정책적으로 사용하는 조직용 orchestration runtime/control plane**으로 고정한다. (2026-03-12)
- 현재 목표는 **조직용 orchestration control plane**이며, task path는 AI-first planning baseline을 기본으로 하고 heuristic/template 경로는 운영 연속성을 위한 `degraded mode`로만 유지한다. (2026-03-13)

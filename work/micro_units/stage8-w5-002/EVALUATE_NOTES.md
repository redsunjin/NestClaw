...
- 결과:
  ...
  - QA worktree stage 8 self-eval baseline: PARTIAL (`G1~G3 PASS`, `G4 PENDING`, `reports/qa/stage8-self-eval-20260311T131552Z.md`)
...
- 그 영향으로 grouped self-eval은 여전히 `7/8 (87%)`이며 `G4`가 `PENDING`이다.

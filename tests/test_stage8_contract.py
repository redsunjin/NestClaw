...
class TestStage8Contract(unittest.TestCase):
    ...
    def test_cli_supports_non_interactive_tool_commands(self) -> None:
        ...
        self.assertIn('subparsers.add_parser("capabilities"', source)
        self.assertIn('subparsers.add_parser("tool-draft"', source)
        self.assertIn('subparsers.add_parser("tool-apply"', source)
        self.assertIn('subparsers.add_parser("tool-validate"', source)
        self.assertIn('subparsers.add_parser("tool-rollback"', source)
        ...
        self.assertIn("build_capability_manifest_service()", source)
    ...
    def test_mcp_server_exposes_required_tools(self) -> None:
        ...
        self.assertIn('"catalog.manifest"', source)
        self.assertIn('"catalog.create_draft"', source)
        self.assertIn('"catalog.get_draft"', source)
        self.assertIn('"catalog.validate_draft"', source)
        self.assertIn('"catalog.apply_draft"', source)
        self.assertIn('"catalog.rollback_tool"', source)
    ...
    def test_tool_registry_is_connected_to_runtime_execution_surfaces(self) -> None:
        ...
        self.assertIn('"/api/v1/agent/recent"', main_source)
        self.assertIn('"/api/v1/agent/report/{task_id}"', main_source)
        self.assertIn('"/api/v1/tools"', main_source)
        self.assertIn('"/api/v1/capabilities"', main_source)
        self.assertIn('"/api/v1/approvals/{queue_id}"', main_source)
        self.assertIn('"/api/v1/tool-drafts"', main_source)
        self.assertIn('"/api/v1/tool-drafts/{draft_id}/validate"', main_source)
        self.assertIn('"/api/v1/tool-drafts/{draft_id}/apply"', main_source)
        self.assertIn('"/api/v1/tools/{tool_id}/rollback"', main_source)
        self.assertIn('"tool_id": capability.tool_id', main_source)
        self.assertIn("CLI_TOOL_CATALOG_SERVICE", cli_source)
        self.assertIn("CLI_CAPABILITY_MANIFEST_SERVICE", cli_source)
        self.assertIn("CLI_TOOL_DRAFT_SERVICE", cli_source)
        self.assertIn("CLI_APPROVAL_SERVICE.get_approval", cli_source)
        self.assertIn("CLI_ORCHESTRATION_SERVICE.agent_recent", cli_source)
        self.assertIn("CLI_ORCHESTRATION_SERVICE.agent_report", cli_source)
        self.assertIn("catalog.list", mcp_source)
        self.assertIn("catalog.manifest", mcp_source)
        self.assertIn("agent.recent", mcp_source)
        self.assertIn("agent.report", mcp_source)
        self.assertIn("approval.get", mcp_source)
        self.assertIn("catalog.create_draft", mcp_source)
        self.assertIn("catalog.validate_draft", mcp_source)
        self.assertIn("catalog.apply_draft", mcp_source)
        self.assertIn("catalog.rollback_tool", mcp_source)
    ...
    def test_web_console_is_exposed_from_root(self) -> None:
        ...
        self.assertIn("renderActionInspector", js_source)
        self.assertIn("rationaleLines", js_source)
    ...
    def test_slack_adapter_and_tool_draft_service_exist(self) -> None:
        ...
        self.assertIn("validate_draft", service_source)
        self.assertIn("rollback_tool", service_source)
    ...
    def test_tool_registry_overlay_support_is_connected(self) -> None:
        ...
        self.assertIn("remove_tool_registry_tool", source)
        self.assertIn("validate_tool_capability", source)
        self.assertIn("compact_overlay_tool_registry", source)
